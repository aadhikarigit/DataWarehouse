...
/****** Object:  Table [dbo].[FactBranchPatientHistoRecords]    Script Date: 7/8/2019 3:09:34 AM ******/
SET ANSI_NULLS ON
GO
...
CREATE TABLE [dbo].[FactBranchPatientHistoRecords](
...
ALTER TABLE [dbo].[FactBranchPatientHistoRecords] ADD  DEFAULT ((0)) FOR [IsSync]
GO