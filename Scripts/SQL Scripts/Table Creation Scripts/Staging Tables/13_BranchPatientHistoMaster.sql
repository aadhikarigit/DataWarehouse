...
/****** Object:  Table [dbo].[BranchPatientHistoMaster]    Script Date: 7/8/2019 3:04:23 AM ******/
SET ANSI_NULLS ON
GO
...
CREATE TABLE [dbo].[BranchPatientHistoMaster](
...
ALTER TABLE [dbo].[BranchPatientHistoMaster] ADD  DEFAULT ((0)) FOR [IsSync]
GO
