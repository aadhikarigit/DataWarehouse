...
/****** Object:  Table [dbo].[BranchPatientMaster]    Script Date: 7/8/2019 3:05:22 AM ******/
SET ANSI_NULLS ON
GO
...
CREATE TABLE [dbo].[BranchPatientMaster](
	...
	[BranchId] [int] NULL,
	[BranchInvoiceNo] [nvarchar](50) NULL,
...
ALTER TABLE [dbo].[BranchPatientMaster] ADD  DEFAULT ((0)) FOR [IsSync]
GO
