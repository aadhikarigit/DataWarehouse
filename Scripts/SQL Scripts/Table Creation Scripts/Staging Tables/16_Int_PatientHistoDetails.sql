...
/****** Object:  Table [dbo].[Int_PatientHistoDetails]    Script Date: 7/8/2019 3:12:32 AM ******/
SET ANSI_NULLS ON
GO
...
CREATE TABLE [dbo].[Int_PatientHistoDetails](
...
ALTER TABLE [dbo].[Int_PatientHistoDetails] ADD  DEFAULT ((0)) FOR [IsSync]
GO

ALTER TABLE [dbo].[Int_PatientHistoDetails] ADD  DEFAULT ((0)) FOR [SyncStatus]
GO